// AUTO-GENERATED from legal_os_prototype/code.html by scripts/convert-stitch-to-react.mjs -- do not edit.
import AppShell from "@/components/alexandria/AppShell";
import "./legal_os_prototype.css";

export default function LegalOsPrototype() {
  return (
    <AppShell pageName="legal_os_prototype">
