// AUTO-GENERATED from command_center_dashboard_1/code.html by scripts/convert-stitch-to-react.mjs -- do not edit.
import AppShell from "@/components/alexandria/AppShell";
import "./command_center_dashboard_1.css";

export default function CommandCenterDashboard1() {
  return (
    <AppShell pageName="command_center_dashboard_1">
