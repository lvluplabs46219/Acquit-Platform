// AUTO-GENERATED from counsel_directory_search/code.html by scripts/convert-stitch-to-react.mjs -- do not edit.
import AppShell from "@/components/alexandria/AppShell";
import "./counsel_directory_search.css";

export default function CounselDirectorySearch() {
  return (
    <AppShell pageName="counsel_directory_search">
...
<button className="w-full py-2 bg-legal-gold text-surface font-data-mono text-data-mono font-bold hover:brightness-110 transition-all border border-legal-gold uppercase tracking-wider">New Filing</button>
</div>
...
<article className="border border-legal-gold bg-surface-container p-6 relative flex flex-col gap-4">
<div className="absolute top-0 right-0 bg-legal-gold text-surface px-2 py-1 text-[10px] font-data-mono uppercase font-bold flex items-center gap-1">
...
<span className="material-symbols-outlined text-sm legal-gold">verified</span>
